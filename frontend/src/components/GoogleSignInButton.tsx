...
import { getErrorCode, getGoogleSignInErrorMessage } from '../lib/authErrors'
...
export default function GoogleSignInButton({ label, onSuccess, onError }: GoogleSignInButtonProps) {
  ...
  const handleClick = async () => {
    ...
    try {
      ...
      // The user closed the popup themselves, or double-clicked the button —
      // not an error worth interrupting them with.
